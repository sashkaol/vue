<template>
  <div>
    <input id="oper1" type="number" v-model.number="oper1" />
    <input id="oper2" type="number" v-model.number="oper2" />
    = {{ result }} <br /><br />
    <div id="operations">
      <button
    ...
    <br />
    <input type="checkbox" id="check" v-model="seeKeyboard" />
    ...
    <div id="keyboard" v-show="seeKeyboard">
      ...
      <button @click="backspace" name="backspace">&#8592;</button>
      <br /><br />
      <div>
        <input
          type="radio"
